...
public class Empleado {
	...
	/**
	 * 
	 * @param apellidos (String) Establece el atributo apellido del objeto de clase
	 *                  Empleado
	 */
	...
	/**
	 * 
	 * @return Devuelve el número (INT) del departamento del objeto de clase
	 *         Empleado
	 */
	public int getDepno() {
		return depno;
	...
	/**
	 * 
	 * @param depno Establece el número (INT) de departamento del objeto de clase
	 *              Empleado
	 */
